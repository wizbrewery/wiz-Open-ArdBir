...
void Stage(byte Stage, float Set, float Temp){
  ...
  if (Stage  >  0 && Stage  < 8) lcd.print(F("OPP* *NED Pause STP"));
  if (Stage ==  8)               lcd.print(F("OPP* *NED  ---  ---"));
  if (Stage ==  9)               lcd.print(F("OPP* *NED  ---  Pmp"));
