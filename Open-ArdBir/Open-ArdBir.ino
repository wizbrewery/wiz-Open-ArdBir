...
void Temperature(){ // modified by wizbrewery reads two DS18B20 temerature probes
  ...
  if (ScaleTemp==1)Temp_Mon = Temp_Mon * 1.8 + 32.0;
  Serial1.print(Temp_Now);
  Serial1.print(Temp_Mon);
  Serial.print("C: ");
